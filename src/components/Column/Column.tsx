...
export const ColumnImplementation = createMaterial3Component(ColumnApi, ({ props, buildChild }) => (
  <div
    className={layoutClasses('m3e-a2ui-column', props.justify, props.align)}
